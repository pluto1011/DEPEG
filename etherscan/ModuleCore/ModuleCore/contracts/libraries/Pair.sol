 ...
 */
struct Pair {
    // pa/ct 페그 자산(PA) 또는 커버 토큰(CT)의 주소
    address pa;
    // ra/ds 상환 자산(RA) 또는 디페그 스왑(DS)의 주소
    address ra;
    // initial arp 초기 연간 위험 프리미엄
    uint256 initialArp;
    // expiry interval 만기 간격
    uint256 expiryInterval;
    // IExchangeRateProvider contract address 환율 제공자 컨트랙트 주소
